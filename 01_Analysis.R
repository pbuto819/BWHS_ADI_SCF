...
### Model 1: Age, Region of Birth, Parental Education ----
...
### Model 2: Education, Region of residence ----
...
# Can any of these variables be treated the same?
# we have the vrf
...
results$multi2$model <- c(rep("Unadjusted Model", 8),
                          rep("Model 1", 8),
                          rep("Model 2", 8),
                          rep("Model 3", 8))
